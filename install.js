...
function createInstallOverlay() {
    ...
    try {
        ...
        console.log("Overlay z-index:", computedStyle.zIndex);
        console.log("Overlay visibility:", computedStyle.visibility);
        console.log("Overlay display:", computedStyle.display);
        console.log("Overlay opacity:", computedStyle.opacity);
    } catch (e) {
        console.log("Could not get computed style:", e);
    }
    ...
    return {
        ...
        close: function() {
            try {
                const overlay = window.top.document.getElementById('squarehero-install-overlay');
                if (overlay) {
                ...
                // Fallback
                const localOverlay = document.getElementById('squarehero-install-overlay');
                if (localOverlay) {
